...
const Modal = props => {
    ...
    return ReactDOM.createPortal(
        <div className="ui dimmer visible modals active" onClick={props.dismiss}>
            <div className="ui standard basic visible modal active" onClick={e => e.stopPropagation()}>
                ...
                <div className="actions" style={{ textAlign: 'center' }}>
                    <div className="ui red cancel inverted button" onClick={() => history.push('/')}>
                        <i className="remove icon"></i>
                        {text.no}
                    </div>
                    <div className="ui green ok inverted button" onClick={() => props.activity()}>
